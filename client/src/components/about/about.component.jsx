  ...
  return (
    <AboutContainer>
      ...
      <p className='mb-4 text-slate-600'>
        DW Estates is a real estate company that provides a platform for people to buy and sell properties. We are a team of real estate professionals who are dedicated to providing the best service to our clients.</p>
