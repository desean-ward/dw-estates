...
const UpdateListing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${URL}/api/listing/update/${listingId}`, {
        method: "PUT",
        credentials: "include",
        sameSite: "none",
        secure: true,
  ...
  return (
    <UpdateListingContainer>
      <UpdateListingHeader>Update a Listing</UpdateListingHeader>

      <UpdateListingForm onSubmit={handleSubmit}>
        <FormInputSection>
          <FormInput
            type='text'
            placeholder='Title'
